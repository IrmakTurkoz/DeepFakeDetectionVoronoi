...
def extract_features(fileDirectory,destination,videos,labels,show_results = False,frame_rate = 50):
                ...
                if frame_count % 30 == 0: 
                    ...
                    if regions:
                        ...
                        for (i, rect) in enumerate(regions):
                            ...
                            # array
                            vor_features = v.createVoronoi(img,destination,predictor,rect,face_id + i,show_results=show_results)
...
def pad_images(fileDirectory,destination):
    max_w = 224
    max_h = 224
    ...
    for filename in os.listdir(fileDirectory):
        ...
        if currentfile:
            ...
            if (xx > 0 and yy > 0):
                ...
                cv2.imwrite(destination + filename, result)